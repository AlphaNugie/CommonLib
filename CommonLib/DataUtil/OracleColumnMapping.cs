...
namespace CommonLib.DataUtil
{
    ...
    public class OracleColumnMapping
    {
        ...
        /// 字段类型
        /// </summary>
        public DbSqlType SqlType { get; set; }
        ...
        public OracleColumnMapping(string columnName, DbSqlType sqlType, string comment = null, int? size = null, bool notNull = false, double? defaultValue = null)
        {
        ...
        public OracleColumnMapping(DataRow dataRow)
        {
            ...
            SqlType = Enum.TryParse(dataRow.Convert<string>("data_type"), ignoreCase: true, out DbSqlType type) ? type : DbSqlType.NONE;
            ...
            else if (SqlType == DbSqlType.VARCHAR2)
                DefaultValue = def;
            else
        ...
        public string GetStructure()
        {
            ...
            string defClause = DefaultValue != null ? string.Format(SqlType == DbSqlType.VARCHAR2 ? " DEFAULT '{0}'" : " DEFAULT {0}", DefaultValue) : string.Empty;
