...
namespace CommonLib.Events
{
    ...
    public delegate void ReconnTimerChangedHandler(object sender, int timerCount);
    ...
    /// <param name="sender">触发事件的对象</param>
    /// <param name="eventArgs">事件数据类对象</param>
    public delegate void DataReceivedHandler(object sender, DataReceivedEventArgs eventArgs);
    ...
    /// <param name="sender">触发事件的对象</param>
    /// <param name="eventArgs">事件数据类对象</param>
    public delegate void DataSendHandler(object sender, DataSendEventArgs eventArgs);
    ...
    public delegate bool DataSendHandler_ByteArray(byte[] data);
    ...
    /// <returns>返回操作结果</returns>
    public delegate bool DataSendHandler_String(string content);
}
